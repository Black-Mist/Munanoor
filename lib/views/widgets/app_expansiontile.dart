...
class _AppExpansionTileState extends State<AppExpansionTile>
  ...
  final IconData iconexpand = Icons.add_circle_rounded;
  final IconData iconcollapse = Icons.remove_circle_rounded;
  final Color iconexpandcolor = Colors.grey;
  final Color iconcollapsecolor = Colors.black54;
  IconData _defaultIcon = Icons.add_circle_rounded;
  ...
  void _handleTap() {
    setState(() {
      ...
      if (_isExpanded) {
        _controller.forward();
        _defaultIcon = iconcollapse;
        _defaultIconColor = iconcollapsecolor;
      } else {
        _defaultIcon = iconexpand;
        _defaultIconColor = iconexpandcolor;
